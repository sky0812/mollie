...
var toFormData = __webpack_require__(7);
...
var defaults = {
  ...
  env: {
    FormData: __webpack_require__(34)
  },
...
var parseProtocol = __webpack_require__(33);
...
registerBlockType('gutenberg-block/fnugg-block', {
    title: 'Fnugg Resort',
    icon: 'palmtree',
    category: 'widgets',
    attributes: {
    ...
    edit: function edit(props) {
        var AutocompleteAPI = [{
            ...
            options: function () {
                var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(search) {
                    var payload, responseArray, results, exception;
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    _context.next = 5;
                                    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('https://api.fnugg.no/suggest/autocomplete/' + payload);

                                case 5:
                                    results = _context.sent;

                                    if (!(results.data.result[0] == undefined)) {
                                        _context.next = 8;
                                        break;
                                    }

                                    return _context.abrupt('return', [{ name: 'Nothing here :(' }]);
        ...
        return wp.element.createElement(
            'div',
            { id: 'block-dynamic-box', style: { maxWidth: '350px' } },
            ...
            wp.element.createElement(
                'p',
                null,
                'Please start typing a resorts name with "/" in the field below and then choose the resort from the' +
                ' options.'
            ),
            wp.element.createElement(
                'p',
                null,
                'Or just enter first word of the resort name.'
            ),
            wp.element.createElement(
                'label',
                null,
...
axios.toFormData = __webpack_require__(7);
